...
// Currently we only have inputText as a state variable and
// hence you might not see the benefits of
// useCallback. We're also not passing it down to another
//component as a prop which is another reason for you to not see it's benefits
//immedietely.
